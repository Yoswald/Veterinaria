    ...
    <div class="navbar-header">
      ...
      <div style="padding: 15px 0;">
         <a href="#" id="msbo"><i class="ic fa fa-bars"> </i></a>
          <div class="titu"><i class="fas fa-home"></i> Inicio </div>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="panel panel-default" id="dropdown">
            ...
            <div id="dropdown-lvl1" class="panel-collapse collapse">
              <div class="panel-body">
                <ul class="nav navbar-nav">
                  <li><a href="paginas/clientes/registrar.php">Clientes</a></li>
                  <li> <a href="paginas/doctores/registrar.php">Doctor</a></li>
          ...
          <li class="panel panel-default" id="dropdown">
            ...
            <div id="dropdown-lvl9" class="panel-collapse collapse">
              <div class="panel-body">
                <ul class="nav navbar-nav">
                               <li> <a href="paginas/clientes/index.php">Lista de Clientes</a></li>
                               <li> <a href="paginas/mascotas/index.php">Lista de Mascotas</a></li>
                               <li> <a href="paginas/doctores/index.php">Lista de Doctores</a></li>
...
<div class="mcw">
 ...
 <h1> Estudiante: Yoswald Nuñez, C.I. 24.929.828,Seccion 2. </h1>

<!-- <div class="cajanoti">
<div class="notif" >  

   <i class="fas fa-exclamation"></i>  Venta solicitada
 <li><a href="controladores/controladorservihilos.php?operacion=venta_completa">Bordados</a> 0</li>
  <li><a href="controladores/controladorservipintu.php?operacion=venta_completa">Estampados</a> 0</li>
...
<div class="notif2" >  
    ...
    <i class="fas fa-exclamation"></i>  Venta en producción
 <li><a href="controladores/controladorservihilos.php?operacion=venta_completa">Bordados</a> 0</li>
 <li><a href="controladores/controladorservipintu.php?operacion=venta_completa">Estampados</a> 0</li>
