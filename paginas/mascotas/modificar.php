         ...
         <div class="col-md-10 box">
           ...
           <div class="col-md-10 box">
              ...
              <div class="cajabox" >
                ...
                <form class="form " method="POST" action="../../conexion/modificar_mascota.php?id=<?php echo $variable->id; ?>">
                    ...
                    <th><label class="color"> (*)  </label>  <input type="text" value="<?php echo $variable->nombre; ?>"  class="form-main col-8" name="nombre" required="required" >
                    </th>
                    ...
                    <th><label class="color"> (*) </label> 
                     ...
                     <input type="radio"  value="gato" class="form-main col-8" <?php if($variable->tipo=="gato"){
                      echo "checked='checked'"; } ?>  name="radiot" required="required" > Gato 

                    <input type="radio"  value="perro" class="form-main col-8"  <?php if($variable->tipo=="perro"){ echo "checked='checked'"; } ?> name="radiot" required="required" > Perro
                    </th>
                    ...
                    <th><label class="color"> (*) </label> 
                     <input type="radio"  value="hembra" class="form-main col-8" <?php if($variable->genero=="hembra"){ echo "checked='checked'"; } ?> name="radios" required="required" > Hembra

                    <input type="radio"  value="macho" class="form-main col-8" <?php if($variable->genero=="macho"){ echo "checked='checked'"; } ?> name="radios" required="required" > Macho
                    </th>

                    <th><label>Fecha de nacimiento</label></th>
                    <th><label class="color"> (*)  </label>  <input type="date" class="form-main col-8" value="<?php echo $variable->fecha_n; ?>" name="fecha_n" required="required" ></th>
                    </th>
                    ...
                    <th><label class="color"> (*) </label> 
                     <input type="radio"  value="vivo" class="form-main col-8" <?php if($variable->estado=="vivo"){ echo "checked='checked'"; } ?> name="radioe" required="required" > Vivo

                    <input type="radio"  value="muerto" class="form-main col-8" <?php if($variable->estado=="muerto"){ echo "checked='checked'"; } ?>  name="radioe" required="required" > Muerto
                    </th>
