         ...
         <div class="col-md-10 box">
           ...
           <div class="col-md-10 box">
              ...
              <div class="cajabox" >
                ...
                <form class="form " method="POST" action="../../conexion/registro_clientes.php">
                    ...
                    <th><label class="color"> (*)  </label>  <input type="text"   class="form-main col-8" name="nombre_completo" required="required" ></th>
                   
                      <tr>
                          <tr>

                    <th><label>Direccion </label></th>
                    <th><label class="color"> (*)  </label>  <input type="text"   class="form-main col-8" placeholder="" name="direccion" required="required" ></th>
                   
                      <tr>

                    <th><label>Teléfono</label></th>
                    <th><label class="color" placeholder=""> (*)  </label> <input type="text"  maxlength="30" class="form-main col-8" name="telefono" required="required" ></th>
