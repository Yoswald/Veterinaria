         ...
         <div class="col-md-10 box">
           ...
           <div class="col-md-10 box">
            ...
            <h1>Lista de clientes</h1>    
              ...
              <table id="example" class="table table-striped table-bordered" style="width:900px">
        ...
        foreach ($cliente as $dato){
          ...
          <tr>
            ...
            <td>
              ...
              <a   class='btn2' href="../../conexion/eliminar_cliente.php?id=<?php echo $dato->id; ?>"><i class='fas fa-times'></i></a>
            </td>
